                  ...
                  <div class="bs-stepper-header" role="tablist">
                    ...
                    <div class="step" data-target="#projectsummary-part">
                      <button type="button" class="step-trigger" role="tab" aria-controls="projectsummary-part" id="projectsummary-part-trigger">
                        ...
                        <span class="bs-stepper-label">Project Summary</span>
                      </button>
                    </div>
                    <div class="line"></div>
                    <div class="step" data-target="#basicinfo-part">
                      <button type="button" class="step-trigger" role="tab" aria-controls="basicinfo-part" id="basicinfo-part-trigger">
                        ...
                        <span class="bs-stepper-label">Basic Information of the SLPA</span>
                      </button>
                    </div>
                    <div class="line"></div>
                  ...
                  <div class="bs-stepper-content">
                    ...
                    <div id="projectsummary-part" class="content" role="tabpanel" aria-labelledby="projectsummary-part-trigger">
                      <div class="form-group">
                        <label>Title of MD Project</label>
                        <input type="text" class="form-control" placeholder="Title of MD Project">
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        <label>Cost of DSWD Funding</label>
                        <input type="text" class="form-control" placeholder="Cost of DSWD Funding">
                      </div>
                      <div class="form-group">
                        <label>Other Fund Source</label>
                        <input type="text" class="form-control" placeholder="Other Fund Source">
                      </div>
                      <button class="btn btn-primary" onclick="stepper.next()">Next</button>
                    </div>

                    <!-- Basic Information of the SLPA -->
